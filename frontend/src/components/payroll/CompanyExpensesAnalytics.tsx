        ...
        <div className="flex flex-col gap-8 w-full animate-in fade-in duration-150">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div className="bg-white border border-gray-200 p-5 flex flex-col justify-between shadow-xs hover:border-black transition-colors">
                    <div className="flex items-center justify-between">
                        <span className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">
                            {isRu ? `Итоговые расходы (${selectedYear})` : `Yillik Jami Xarajat (${selectedYear})`}
                        </span>
                    ...
                    <div className="text-[11px] font-semibold text-gray-500 flex items-center justify-between border-t border-gray-100 pt-2">
                        ...
                        <span className="font-bold text-orange-700">{formatMoney(data?.yearlyTotalManualExpenses || 0)}</span>
                    </div>
                </div>
                ...
                <div className="bg-white border border-gray-200 p-5 flex flex-col justify-between shadow-xs hover:border-black transition-colors">
                    <div className="flex items-center justify-between">
                        <span className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">
                            {isRu ? "Среднемесячный расход" : "Oylik O'rtacha Xarajat"}
                        </span>
                        <span className="text-xl">📈</span>
                    </div>
                    <div className="my-3">
                    ...
                    <div className="text-[11px] font-semibold text-gray-500 flex items-center justify-between border-t border-gray-100 pt-2">
                        <span>{isRu ? "Сотрудников:" : "Xodimlar soni:"}</span>
                ...
                >
                    <div className="flex items-center justify-between">
                        <span className="text-[10px] font-black text-rose-800 uppercase tracking-widest flex items-center gap-1.5">
                            <span>🔴</span> {isRu ? "Месяц с макс. расходом" : "Eng Ko'p Xarajat Bo'lgan Oy"}
                        </span>
                    ...
                    <div className="text-[11px] font-bold text-rose-700 flex items-center justify-between border-t border-rose-200 pt-2">
                        <span>{isRu ? "Доля в году:" : "Yillik ulushi:"} {data?.maxExpenseMonth?.percentageOfYear || 0}%</span>
                        <span className="group-hover:translate-x-1 transition-transform">{isRu ? "Подробнее →" : "Tafsilotlar →"}</span>
                    </div>
                </div>
                ...
                >
                    <div className="flex items-center justify-between">
                        <span className="text-[10px] font-black text-emerald-800 uppercase tracking-widest flex items-center gap-1.5">
                            <span>🟢</span> {isRu ? "Месяц с мин. расходом" : "Eng Kam Xarajat Bo'lgan Oy"}
                        </span>
                    ...
                    <div className="text-[11px] font-bold text-emerald-700 flex items-center justify-between border-t border-emerald-200 pt-2">
                        <span>{isRu ? "Доля в году:" : "Yillik ulushi:"} {data?.minExpenseMonth?.percentageOfYear || 0}%</span>
                        <span className="group-hover:translate-x-1 transition-transform">{isRu ? "Подробнее →" : "Tafsilotlar →"}</span>
                    </div>
                </div>
            </div>
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-gray-200 pb-4 mb-6">
                    <div>
                        <h3 className="text-sm font-black uppercase tracking-wider text-black flex items-center gap-2">
                            <span>📈</span> {selectedYear} {isRu ? "Диаграмма помесячных расходов компании" : "Yil Oylik Xarajatlar Diagrammasi"}
                        </h3>
                        <p className="text-xs text-gray-500 font-medium mt-0.5">
                            {isRu ? "Нажмите на любой месяц, чтобы открыть подробную структуру и расходы" : "Ixtiyoriy oy ustuniga bosib, o'sha oyning foiz taqsimoti va xarajatlarini ko'rishingiz mumkin"}
                        </p>
                    </div>
                    ...
                    <div className="flex items-center gap-3 text-xs font-bold">
                        <div className="flex items-center gap-1.5">
                            ...
                            <span className="text-gray-600">{isRu ? "Макс. расход" : "Eng ko'p xarajat"}</span>
                        </div>
                        <div className="flex items-center gap-1.5">
                            <span className="w-3 h-3 bg-emerald-600 inline-block rounded-xs"></span>
                            <span className="text-gray-600">{isRu ? "Мин. расход" : "Eng kam xarajat"}</span>
                        </div>
                        <div className="flex items-center gap-1.5">
                            <span className="w-3 h-3 bg-indigo-900 inline-block rounded-xs"></span>
                            <span className="text-gray-600">{isRu ? "Выбранный месяц" : "Tanlangan oy"}</span>
                        </div>
                    </div>
                </div>
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="opacity-0 group-hover:opacity-100 transition-opacity absolute -top-12 z-20 pointer-events-none bg-black text-white text-[10px] font-bold py-1 px-2 whitespace-nowrap shadow-lg rounded">
                                    ...
                                    <div className="text-[9px] text-gray-300">{isRu ? "Кликните для деталей" : "Bosish orqali ochish"}</div>
                                </div>
                ...
                <div className="bg-white border-2 border-black p-6 shadow-sm flex flex-col gap-6">
                    ...
                    <div>
                        ...
                        <div className="h-5 w-full bg-gray-100 rounded flex overflow-hidden border border-gray-200 mb-4">
                            ...
                            >
                                {activeDrillMonth.percentages?.baseSalary > 12 ? `${activeDrillMonth.percentages?.baseSalary}%` : ""}
                            </div>
                            <div
                            ...
                            <div
                                ...
                                title={`Operatsion xarajatlar: ${activeDrillMonth.percentages?.manualExpenses || 0}%`}
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
                            <div className="p-3 bg-blue-50/70 border border-blue-200">
                                <div className="text-[10px] font-bold uppercase text-blue-900 flex items-center justify-between">
                                    <span>💼 {isRu ? "Оклады (ФОТ)" : "Asosiy Oyliklar"}</span>
                    ...
                    <div>
                        <div className="text-xs font-black uppercase tracking-wider text-gray-700 mb-3">
                            3. {isRu ? "Распределение по отделам компании" : "Bo'limlar Kesimida Taqsimot"} ({activeDrillMonth.departmentBreakdown?.length || 0} ta bo'lim)
                        </div>
                            ...
                            {(activeDrillMonth.departmentBreakdown || []).map((dept: any, idx: number) => (
                                <div key={idx} className="p-3.5 bg-gray-50 border border-gray-200 flex flex-col justify-between gap-2">
                                    ...
                                    <div className="flex items-center justify-between text-[11px] text-gray-500 font-medium">
                                        <span>{dept.employeesCount} {isRu ? "сотрудников" : "ta xodim"}</span>
                    ...
                    <div>
                        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-3">
                            <div className="text-xs font-black uppercase tracking-wider text-gray-700">
                                4. {isRu ? "Список сотрудников и выплаты за месяц" : "Xodimlar Kesimida Oyliklar va To'lovlar"} ({filteredEmployeeList.length} ta)
                            </div>
                            <input
                                type="text"
            ...
            <div className="bg-white border border-gray-200 p-6 shadow-xs">
                <div className="flex items-center justify-between border-b border-gray-200 pb-4 mb-4">
                    <div>
                        <h3 className="text-sm font-black uppercase tracking-wider text-black flex items-center gap-2">
                            <span>📋</span> {selectedYear} {isRu ? "Сравнительная таблица расходов за 12 месяцев" : "Yil — 12 Oylik Xarajatlar Taqqoslama Jadvali"}
                        </h3>
                        <p className="text-xs text-gray-500 font-medium mt-0.5">
                            {isRu
                                ? "Оклады, бонусы, авансы, прямые расходы компании и годовая доля каждого месяца"
                                : "Har bir oyning oyliklari, bonuslari, avanslari, operatsion xarajatlari va yillik ulushi"}
                        </p>
                    </div>
                </div>
                    ...
                    <table className="w-full text-left border-collapse text-xs">
                        <thead>
                            <tr className="border-b border-gray-200 bg-gray-50 text-[10px] font-black uppercase tracking-wider text-gray-500">
                                ...
                                <th className="py-3 px-4">{isRu ? "Месяц" : "Oy nomi"}</th>
                                <th className="py-3 px-4 text-right">{isRu ? "Оклады" : "Asosiy ish haqi"}</th>
                                <th className="py-3 px-4 text-right">{isRu ? "Бонусы" : "Bonuslar"}</th>
                                <th className="py-3 px-4 text-right">{isRu ? "Авансы" : "Avanslar"}</th>
                                <th className="py-3 px-4 text-right">{isRu ? "Операционные расходы" : "Operatsion xarajat"}</th>
                                <th className="py-3 px-4 text-right">{isRu ? "Общий расход" : "Jami Xarajat"}</th>
                                <th className="py-3 px-4 text-center">{isRu ? "Доля в году" : "Yillik ulush"}</th>
                                <th className="py-3 px-4 text-center">{isRu ? "Действие" : "Amal"}</th>
                            </tr>
                        </thead>
                        <tbody className="divide-y divide-gray-100">
                                ...
                                return (
                                    <tr key={m.month} className="hover:bg-gray-50 transition-colors">
                                        ...
                                        <td className="py-3 px-4 text-right font-bold text-orange-600">
                                            {m.manualExpenses > 0 ? `${Number(m.manualExpenses).toLocaleString()} UZS` : "-"}
                                        </td>
                                        ...
                                        <td className="py-3 px-4 text-center">
                                            <button
                                                ...
                                                className="px-3 py-1 bg-black text-white text-[10px] font-bold uppercase tracking-wider hover:bg-zinc-800 transition-colors cursor-pointer"
                                            >
